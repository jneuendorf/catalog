...
var removeEmpty = ramda.filter(ramda.complement(ramda.isEmpty));
var splitType = ramda.compose(removeEmpty, ramda.split("|"));
var splitOptions = ramda.compose(removeEmpty, ramda.split(","));
...
var parseSpecimenOptions = function parseSpecimenOptions() {
  ...
  return function () {
    ...
    return ramda.mergeAll(splitOptions(restOptions).map(optionToKeyValue(mapOptionsToProps)));
  };
};
...
var parseYaml = function parseYaml(str, imports) {
  var parsed = void 0;
  try {
    var ImportType = new jsYaml.Type("!import", {
      kind: "scalar",
    ...
    var yamlOptions = {
      schema: jsYaml.Schema.create(jsYaml.CORE_SCHEMA, [ImportType])
    };

    parsed = jsYaml.safeLoad(str, yamlOptions);
  } catch (e) {
    parsed = void 0;
  }
  ...
  return function (WrappedSpecimen) {
    var SpecimenContainer = function SpecimenContainer(props, _ref) {
      ...
      return React__default.createElement(
        Span,
        { span: span },
        React__default.createElement(WrappedSpecimen, _extends({}, optionProps, bodyProps, props, {
          catalog: catalog
        }))
      );
    };
...
var Code = function (_React$Component) {
  ...
  Code.prototype.render = function render() {
    ...
    var content = viewSource ? React__default.createElement(HighlightedCode, {
      language: lang,
...
var RawCode = function RawCode(props) {
  return React__default.createElement(Code$1, _extends({}, props, { raw: true }));
};
...
var Color = function (_React$Component) {
  ...
  Color.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      React__default.createElement("div", { className: /*#__PURE__*/ /*#__PURE__*/css({ height: 120, background: value }, "label:Color;", "label:Color;") }),
      React__default.createElement(
        "div",
...
var _ColorPaletteItem = function _ColorPaletteItem(_ref) {
  ...
  var contrastingValue = d3Color.hcl(value).l < 55 ? "#fff" : "#000";
  return React__default.createElement(
    "div",
    {
...
var ColorPalette = function (_React$Component) {
  ...
  ColorPalette.prototype.render = function render() {
    ...
    var paletteItems = colors.map(function (color, i) {
      return React__default.createElement(ColorPaletteItem, _extends({ key: i }, color, { styles: styles, width: width }));
    });
...
var renderStyles = function renderStyles(styles) {
  return styles.map(function (src, i) {
    return React__default.createElement("link", { key: i, href: src, rel: "stylesheet", type: "text/css" });
  });
};
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          FrameComponent,
          {
            ...
            head: [React__default.createElement(
              "style",
              { key: "stylereset" },
...
var ReactParser = function (_marked$Parser) {
  ...
  ReactParser.parse = function parse(src, options) {
    var parser = new ReactParser(options);
    return parser.parse(src);
  };

  ReactParser.prototype.parse = function parse(src) {
...
var Link = function Link(_ref, _ref2) {
  ...
  return isInternalPath(parsedTo, catalog) ? React__default.createElement(reactRouter.Link, _extends({ to: parsedTo }, rest)) : React__default.createElement("a", _extends({ href: getPublicPath(to, catalog) }, rest));
};
...
var HeadingWithLink = function HeadingWithLink(_ref) {
  ...
  return React__default.createElement(tag, { id: slug, className: headingStyle }, text$$1, " ", React__default.createElement(
    "span",
    { className: linkStyle },
    React__default.createElement(HeadingLink, { slug: slug })
  ));
};
...
var PlainHeading = function PlainHeading(_ref2) {
  ...
  var tag = "h" + level;
  return React__default.createElement(tag, null, text$$1);
};
...
var Heading = function Heading(_ref3, _ref4) {
  ...
  return slug ? React__default.createElement(HeadingWithLink, { level: level, text: text$$1, slug: slug, catalog: catalog }) : React__default.createElement(PlainHeading, { level: level, text: text$$1, catalog: catalog });
};
...
var BlockQuote = function BlockQuote(props) {
  return React__default.createElement("blockquote", _extends({ className: blockquoteStyle() }, props));
};
var Hr = styled("hr", {
  border: "none",
  flexBasis: "100%",
...
var Link$1 = function Link$$1(props, _ref4) {
...
var ReactRenderer = function () {
  ...
  ReactRenderer.prototype.heading = function heading(text, level, raw) {
    ...
    return React__default.createElement(Heading, { text: text, level: level, slug: slug });
  };

  ReactRenderer.prototype.hr = function hr() {
    return React__default.createElement(Hr, { key: this.getKey() });
  };

  ReactRenderer.prototype.br = function br() {
    return React__default.createElement("br", { key: this.getKey() });
  };

  ReactRenderer.prototype.list = function list(body, ordered) {
    var key = this.getKey();
    return ordered ? React__default.createElement(
      OrderedList,
      { key: key },
      body
    ) : React__default.createElement(
  ...
  ReactRenderer.prototype.image = function image(href, title, alt) {
    return React__default.createElement(Image, { src: href, title: title, alt: alt, key: this.getKey() });
  };
  ...
  Hint.prototype.render = function render() {
    ...
    var markdownRenderer = {
      heading: function heading$$1(textParts, level, raw) {
        var slug = this.slugger.slug(raw);
        return React__default.createElement("h" + level, {
          key: slug,
          id: slug,
  ...
  return React__default.createElement(
    ...
    sizes.map(function (val, i) {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(Preview, { proportion: val.width / val.height }),
        React__default.createElement(
          "div",
...
var runscript = (function (srcOrEl) {
  if (ramda.is(String, srcOrEl) && !ramda.isEmpty(srcOrEl.trim())) {
    enqueue(execRemote(srcOrEl));
  }
  if (srcOrEl.textContent && !ramda.isEmpty(srcOrEl.textContent.trim())) {
...
var Html = function (_React$Component) {
  ...
  Html.prototype.render = function render() {
    ...
    var content = React__default.createElement("div", { dangerouslySetInnerHTML: { __html: children } });
    ...
    return React__default.createElement(
      ...
      toggle,
      options.responsive && parentWidth && activeScreenSize && React__default.createElement(ResponsiveTabs, {
        theme: theme,
        sizes: validSizes,
        action: this.setSize,
      ...
      (!options.responsive || parentWidth) && React__default.createElement(
        "div",
        {
        ...
        frame || activeScreenSize ? React__default.createElement(
          Frame,
          {
...
var Image$1 = function (_React$Component) {
  ...
  Image.prototype.render = function render() {
    ...
    var imageSrcset = srcset.parse(src).map(function (img) {
      return _extends({}, img, { url: getPublicPath(img.url, catalog) });
    });
    var overlaySrcset = overlay ? srcset.parse(overlay).map(function (img) {
      return _extends({}, img, { url: getPublicPath(img.url, catalog) });
    }) : [];
  ...
  Table.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          "thead",
          { className: /*#__PURE__*/ /*#__PURE__*/css(head, "label:Table;", "label:Table;") },
          React__default.createElement(
            "tr",
            null,
            tableKeys.map(function (key, k) {
              return React__default.createElement(HeadingCell, { value: key, key: k, style: cell });
            })
          )
        ),
        React__default.createElement(
          ...
          rows.map(function (row, i) {
            return React__default.createElement(
              ...
              tableKeys.map(function (key, k) {
                return React__default.createElement(Cell, { value: row[key], key: k, style: cell });
              })
            );
          })
        )
...
var Type = function (_React$Component) {
  inherits(Type, _React$Component);
  ...
  Type.prototype.render = function render() {
    ...
    var description = React__default.createElement(
      ...
      options.color ? React__default.createElement(
        "li",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.list, "label:description;", "label:description;") },
        "color: ",
        options.color + ";"
      ) : null,
      options.background ? React__default.createElement(
        "li",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.list, "label:description;", "label:description;") },
        "background-color: ",
        options.background + ";"
      ) : null,
      fontWeight !== "normal" ? React__default.createElement(
        "li",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.list, "label:description;", "label:description;") },
        "font-weight: ",
        options.weight + ";"
      ) : null,
      isItalic !== "normal" ? React__default.createElement(
        "li",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.list, "label:description;", "label:description;") },
        "font-style: ",
        options.style + ";"
      ) : null,
      letterSpacing ? React__default.createElement(
        "li",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.list, "label:description;", "label:description;") },
        "letter-spacing: ",
        options.tracking + ";"
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        headings,
        headings && paragraphs ? React__default.createElement("br", null) : null,
        paragraphs,
        description
      )
    );
...
var DownloadIcon = function DownloadIcon(_ref // eslint-disable-line
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement("rect", { width: "120", height: "120", fill: "#EEEEEE", rx: "2" }),
      React__default.createElement(
        "g",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.icon, "label:DownloadIcon;", "label:DownloadIcon;") },
        React__default.createElement("path", { d: "M72.647 53.353c-.468-.47-1.226-.47-1.697 0L61 63.303V36.2c0-.662-.538-1.2-1.2-1.2-.662 0-1.2.538-1.2 1.2v27.103l-9.95-9.95c-.47-.47-1.23-.47-1.7 0-.468.468-.468 1.226 0 1.697l12 12c.236.232.543.35.85.35.307 0 .614-.118.85-.353l12-12c.468-.468.468-1.226-.003-1.694z" }),
        React__default.createElement("path", { d: "M79 75.8H40.6c-1.985 0-3.6-1.615-3.6-3.6v-4.8c0-.662.538-1.2 1.2-1.2.662 0 1.2.538 1.2 1.2v4.8c0 .662.538 1.2 1.2 1.2H79c.662 0 1.2-.538 1.2-1.2v-4.8c0-.662.538-1.2 1.2-1.2.662 0 1.2.538 1.2 1.2v4.8c0 1.985-1.615 3.6-3.6 3.6z" })
      )
    )
  );
};
...
var DownloadSpecimen = function (_React$Component) {
  ...
  DownloadSpecimen.prototype.render = function render() {
    ...
    var image = this.props.span !== 1 ? React__default.createElement(DownloadIcon, { styles: styles }) : null;
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        "a",
        {
          ...
          href: getPublicPath(url$$1, catalog),
          download: filename
        },
        image,
        React__default.createElement(
...
var reactElementToString = function reactElementToString(el) {
  ...
  var formatProp = function formatProp(k, v) {
    ...
    if (React__default.isValidElement(v)) {
...
var cachedTransform = function cachedTransform(jsx) {
  ...
  var transformed = babelStandalone.transform(jsx, {
    compact: true,
    presets: presets,
...
var transformJSX = (function (jsx, imports) {
  ...
  try {
    ...
    var element = new (Function.prototype.bind.apply(Function, [null].concat(["React"], importKeys, [code])))().apply(undefined, [React__default].concat(importModules));
...
var ReactSpecimen = function (_Component) {
  ...
  ReactSpecimen.prototype.render = function render() {
    ...
    if (jsx$$1) {
      ...
      error = transformed.error ? React__default.createElement(
        Hint$1,
        { warning: true },
    ...
    var source = viewSource ? React__default.createElement(
      "div",
      { className: /*#__PURE__*/ /*#__PURE__*/css(styles.source, "label:source;", "label:source;") },
      React__default.createElement(HighlightedCode, { language: "jsx", code: code, theme: theme })
    ) : null;
...
var getType = ramda.compose(ramda.toLower, ramda.head, ramda.split("|"));

var parseSpecimenType = function parseSpecimenType() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  return ramda.or(getType(options), "raw-code");
};
...
var MarkdownSpecimen = function (_Component) {
  ...
  MarkdownSpecimen.prototype.render = function render() {
    ...
    return React__default.createElement(Specimen, { rawOptions: options, rawBody: body });
  };
        ...
        var md = typeof child === "string" ? renderMarkdown({
          ...
          renderer: {
            code: function code(body, options) {
              return React__default.createElement(MarkdownSpecimen, {
                key: getSpecimenKey(),
                body: body,
                options: options || "",
...
var configure = (function (config) {
  ...
  var basePath = config.useBrowserHistory ? addLeadingSlash(stripTrailingSlashes(config.basePath || url.parse(publicUrl).pathname || "")) : addLeadingSlash(stripTrailingSlashes(config.basePath || ""));
...
var NavigationBar = function (_React$Component) {
  ...
  NavigationBar.prototype.render = function render() {
    ...
    var leftIcon = React__default.createElement(
      "svg",
      {
    ...
    var rightIcon = React__default.createElement(
      "svg",
      {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        previousPage && React__default.createElement(
          Link,
          {
      ...
      React__default.createElement(
        ...
        nextPage && React__default.createElement(
          Link,
          {
            to: nextPage.path,
...
var MenuIcon = function MenuIcon(props) {
  return React__default.createElement(
    ...
    React__default.createElement(
      "g",
      { fill: "currentColor" },
      React__default.createElement("rect", { x: "0", y: "16", width: "26", height: "4" }),
      React__default.createElement("rect", { x: "0", y: "8", width: "26", height: "4" }),
      React__default.createElement("rect", { x: "0", y: "0", width: "26", height: "4" })
    )
  );
};
  ...
  AppLayout.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        theme.showHeader && React__default.createElement(PageHeader, {
          theme: theme,
          title: page.title,
        ...
        !page.hideFromMenu && React__default.createElement(NavigationBar, {
          theme: theme,
          nextPage: nextPage,
          previousPage: previousPage
        })
      ),
      theme.showHeader && React__default.createElement(MenuIcon, {
      ...
      theme.showSideNav && React__default.createElement(
        "div",
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      pages.filter(function (page) {
        ...
        return React__default.createElement(ListItem$1, { key: page.id, page: page, nested: true, theme: theme });
      })
    )
  );
};
...
var ListItem$1 = function (_React$Component) {
  ...
  ListItem.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      pages ? React__default.createElement(NestedList, _extends({}, this.props, page, { pages: pages })) : React__default.createElement(
        Link,
        {
          className: linkStyle,
...
var App = function (_React$Component) {
  ...
  App.prototype.render = function render() {
    ...
    return React__default.createElement(
      AppLayout,
      _extends({}, catalog, { sideNav: React__default.createElement(Menu, catalog) }),
      React__default.createElement(DocumentTitle, { title: getDocumentTitle(catalog) }),
...
var Loader = function (_React$Component) {
  ...
  Loader.prototype.render = function render() {
    ...
    return React__default.createElement("div", { className: /*#__PURE__*/ /*#__PURE__*/css(loader, "label:Loader;", "label:Loader;") });
  };
...
var renderContent = function renderContent(Content) {
  return typeof Content === "string" ? React__default.createElement(
    Page,
    null,
    Content
...
var fetchMarkdown = function fetchMarkdown(url$$1) {
  return fetch(url$$1, {
...
var PageLoader = function (_PureComponent) {
  ...
  PageLoader.prototype.render = function render() {
    ...
    return Content.__catalog_loader__ === true ? React__default.createElement(Content, { location: location }) : React__default.createElement(PageRenderer, { location: location, content: Content });
  };
...
var pageLoader = (function (urlOrComponentPromise) {
  return function (_ref // eslint-disable-line react/prop-types
    ...
    var location = _ref.location;
    return React__default.createElement(PageLoader, {
      location: location,
...
var pageToJSXRoute = function pageToJSXRoute(_ref2) {
  var path = _ref2.path,
      ...
      src = _ref2.src;
  return React__default.createElement(reactRouter.Route, {
    key: path,
    path: path,
    component: component ? requireModuleDefault(component) : pageLoader(src)
  });
...
var render = (function (configuration, element) {
  ReactDOM__default.render(React__default.createElement(Catalog, configuration), element);
});
...
var markdownPage = function markdownPage(strings) {
  ...
  return React.createElement.apply(undefined, [Page, {}].concat(values.reduce(function (a, v, i) {
...
var Card = function Card(props) {
  ...
  return React__default.createElement(Page, props);
};
...
exports.configureJSXRoutes = configureJSXRoutes;
exports.markdown = markdownPage;
exports.pageLoader = pageLoader;
exports.DefaultTheme = DefaultTheme;
exports.DefaultResponsiveSizes = DefaultResponsiveSizes;
...
exports.mapSpecimenOption = mapSpecimenOption;
exports.AudioSpecimen = Audio$1;
exports.CodeSpecimen = Code$1;
exports.ColorSpecimen = Color$1;
exports.ColorPaletteSpecimen = ColorPalette$1;
exports.HtmlSpecimen = Html$1;
exports.HintSpecimen = Hint$1;
exports.ImageSpecimen = Image$2;
exports.TableSpecimen = Table$1;
exports.TypeSpecimen = Type$1;
exports.DownloadSpecimen = Download;
exports.ReactSpecimen = ReactSpecimen$1;
exports.VideoSpecimen = Video$1;
//# sourceMappingURL=catalog.cjs.js.map
